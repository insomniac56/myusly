...
const updateDocumentTitle = (playerState) => {
    ...
    document.title = paused ? documentTitle : `${trackName} • ${artistNameStr} | Bajaao`;
...
/**
 * Set the volume icon based on the specified volume label.
 *  
 * @param {number} volume - The volume label as a percentage (0 to 100). 
 */
...
const player = new Spotify.Player({
  ...
  // call an event when any changes occur in player
