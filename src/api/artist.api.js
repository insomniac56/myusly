...
/**
 * Get Spotify catalog information for a single artist identified by artistId
 * 
 * @param {Object} req - server request object
 * @returns {Object}
 */ 
 ...
 * 
 * @param {Object} req - server request object
 * @param {string} id - the Spotify Id og the artist
 * @returns {Object}
 */ 
...
/**
 * Get Spotify catalog information about an artist's related artists. Similarly is based on analysis of the the Spotify community's listening history
 * 
 * @param {Object} req - server request object
 * @param {string} id - the Spotify ID of the artist
 * @returns {Object}
